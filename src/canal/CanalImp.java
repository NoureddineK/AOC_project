...
import Callable.GetValuePromise;
...
public class CanalImp implements Canal {
	...
	@Override
	public int getValue() {
		GetValuePromise cGetVal = new GetValuePromise(this.generator);
	...
	public void update(Promise promise) {
		...
		UpdatePromise callableEpoquSart = new UpdatePromise(promise,
				(Display) observerCanal);
		Future<Integer> future = MyExecutorService.submit(callableEpoquSart, DELAY * 100);
	}
